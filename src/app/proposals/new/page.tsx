...
export default function NewProposalPage() {
  ...
  const [policyholderData, setPolicyholderData] =
    useState<PolicyholderFormData | null>(null);
      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        {currentStep === 'policyholder' && (
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <form
              onSubmit={policyholderForm.handleSubmit(handlePolicyholderSubmit)}
              className="space-y-4"
            >
              <div>
                <Label htmlFor="policyholder-company-search">
                  Search Company
                </Label>
                <CompanySearch
              ...
              <div>
                ...
                {policyholderForm.formState.errors.companyName && (
                  <p className="text-red-500 text-sm mt-1">
                    {policyholderForm.formState.errors.companyName.message}
                  </p>
                )}
              </div>

              <div>
                <Label htmlFor="policyholder-companyNumber">
                  Company Number
                </Label>
                <Input
                ...
                {policyholderForm.formState.errors.companyNumber && (
                  <p className="text-red-500 text-sm mt-1">
                    {policyholderForm.formState.errors.companyNumber.message}
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {policyholderForm.formState.errors.contactName && (
                    <p className="text-red-500 text-sm mt-1">
                      {policyholderForm.formState.errors.contactName.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {policyholderForm.formState.errors.email && (
                    <p className="text-red-500 text-sm mt-1">
                      {policyholderForm.formState.errors.email.message}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                {policyholderForm.formState.errors.phone && (
                  <p className="text-red-500 text-sm mt-1">
                    {policyholderForm.formState.errors.phone.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {policyholderForm.formState.errors.address && (
                  <p className="text-red-500 text-sm mt-1">
                    {policyholderForm.formState.errors.address.message}
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  {policyholderForm.formState.errors.city && (
                    <p className="text-red-500 text-sm mt-1">
                      {policyholderForm.formState.errors.city.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {policyholderForm.formState.errors.postcode && (
                    <p className="text-red-500 text-sm mt-1">
                      {policyholderForm.formState.errors.postcode.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {policyholderForm.formState.errors.country && (
                    <p className="text-red-500 text-sm mt-1">
                      {policyholderForm.formState.errors.country.message}
                    </p>
                  )}
                </div>
              </div>
        ...
        {currentStep === 'contract' && (
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <form
              onSubmit={contractForm.handleSubmit(handleContractSubmit)}
              className="space-y-4"
            >
              <div>
                ...
                <Input
                  ...
                  className={
                    contractForm.formState.errors.title ? 'border-red-500' : ''
                  }
                />
                {contractForm.formState.errors.title && (
                  <p className="text-red-500 text-sm mt-1">
                    {contractForm.formState.errors.title.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {contractForm.formState.errors.description && (
                  <p className="text-red-500 text-sm mt-1">
                    {contractForm.formState.errors.description.message}
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {contractForm.formState.errors.endDate && (
                    <p className="text-red-500 text-sm mt-1">
                      {contractForm.formState.errors.endDate.message}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  className={
                    contractForm.formState.errors.amount ? 'border-red-500' : ''
                  }
                />
                {contractForm.formState.errors.amount && (
                  <p className="text-red-500 text-sm mt-1">
                    {contractForm.formState.errors.amount.message}
                  </p>
                )}
              </div>
              ...
              <div className="flex justify-between mt-8">
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => setCurrentStep('policyholder')}
                >
                  Previous
                </Button>
        ...
        {currentStep === 'beneficiary' && (
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <form
              onSubmit={beneficiaryForm.handleSubmit(handleBeneficiarySubmit)}
              className="space-y-4"
            >
              <div>
                <Label htmlFor="beneficiary-company-search">
                  Search Company
                </Label>
                <CompanySearch
              ...
              <div>
                ...
                {beneficiaryForm.formState.errors.companyName && (
                  <p className="text-red-500 text-sm mt-1">
                    {beneficiaryForm.formState.errors.companyName.message}
                  </p>
                )}
              </div>

              <div>
                <Label htmlFor="beneficiary-companyNumber">
                  Company Number
                </Label>
                <Input
                ...
                {beneficiaryForm.formState.errors.companyNumber && (
                  <p className="text-red-500 text-sm mt-1">
                    {beneficiaryForm.formState.errors.companyNumber.message}
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {beneficiaryForm.formState.errors.contactName && (
                    <p className="text-red-500 text-sm mt-1">
                      {beneficiaryForm.formState.errors.contactName.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {beneficiaryForm.formState.errors.email && (
                    <p className="text-red-500 text-sm mt-1">
                      {beneficiaryForm.formState.errors.email.message}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                {beneficiaryForm.formState.errors.phone && (
                  <p className="text-red-500 text-sm mt-1">
                    {beneficiaryForm.formState.errors.phone.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {beneficiaryForm.formState.errors.address && (
                  <p className="text-red-500 text-sm mt-1">
                    {beneficiaryForm.formState.errors.address.message}
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  {beneficiaryForm.formState.errors.city && (
                    <p className="text-red-500 text-sm mt-1">
                      {beneficiaryForm.formState.errors.city.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {beneficiaryForm.formState.errors.postcode && (
                    <p className="text-red-500 text-sm mt-1">
                      {beneficiaryForm.formState.errors.postcode.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {beneficiaryForm.formState.errors.country && (
                    <p className="text-red-500 text-sm mt-1">
                      {beneficiaryForm.formState.errors.country.message}
                    </p>
                  )}
                </div>
              </div>
