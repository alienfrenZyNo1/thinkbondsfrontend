...
export default function WholesalerSettingsPage() {
  ...
  const canEditSettings =
    ...
    (groups.includes(UserRole.WHOLESALE) && groups.includes('master')); // Assuming 'master' is a special role for master users
        ...
        <div className="p-6">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded p-4">
            <p className="text-yellow-700">
              You don't have permission to view wholesaler settings.
            </p>
          </div>
        </div>
      </ProtectedRoute>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      setDueDiligence({
                        ...dueDiligence,
                        policyholderReports: e.target.value
                          .split(',')
                          .map(item => item.trim())
                          .filter(item => item) as string[],
                      })
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      setDueDiligence({
                        ...dueDiligence,
                        beneficiaryReports: e.target.value
                          .split(',')
                          .map(item => item.trim())
                          .filter(item => item) as string[],
                      })
            ...
            {mutation.isError && (
              <div className="bg-red-50 border border-red-200 rounded p-4">
                <p className="text-red-700">
                  Error saving settings: {(mutation.error as Error).message}
                </p>
              </div>
            )}
          </form>
