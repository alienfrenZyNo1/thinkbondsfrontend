...
test.describe('Simple Test', () => {
  test('should display simple test page with working button', async ({ page }) => {
    ...
    await expect(page.locator('text=This is a simple test page with a basic button')).toBeVisible();
